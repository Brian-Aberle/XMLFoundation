/*
 * @(#)src/contract/jvm/sov/jni.h, xs130, xs130, 20000615 1.8.1.1
 * ===========================================================================
...
struct JNIInvokeInterface_ {
    ...
    jint (JNICALL *ResetJavaVM)(JavaVM *vm);                        /*ibm@5596*/
};
...
struct JavaVM_ {
    ...
    jint ResetJavaVM(){                                             /*ibm@5596*/
        return functions->ResetJavaVM(this);
    }
#endif
};
...
JNIEXPORT_PROTOTYPE jint JNICALL                                      /*ibm.54*/
JNI_OnLoad(JavaVM *vm, void *reserved);

JNIEXPORT_PROTOTYPE void JNICALL                                      /*ibm.54*/
