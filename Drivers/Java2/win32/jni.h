 ...
 * Portions copyright (C) 1993-1996 Sun Microsystems, Inc. All Rights Reserved.
 * Portions copyright (c) 1996 Netscape Communications Corporation. All rights reserved.
 */
...
typedef struct MS_JDK1_1Property {
    const jchar   *pcwszProperty;               /* Unicode          */
    const jchar   *pcwszValue;                  /* Unicode          */
} MS_JDK1_1Property;

typedef struct MS_JDK1_1InitArgs {
    unsigned long           nVersion;           /* 0x00010001       */
    unsigned long           nFlags;             /* JNI_IAF_* flags  */
    const char              *pcszClasspath;     /* ANSI             */
    unsigned long           cProperties;
    const MS_JDK1_1Property *pProperties;
} MS_JDK1_1InitArgs;

#define JNI_IAF_VERIFY_ALL_CLASSES  0x00000001

typedef struct MS_JDK1_1AttachArgs {
