========================================================================
    ACTIVE TEMPLATE LIBRARY : ATLExample2012 Project Overview
========================================================================

AppWizard has created this ATLExample2012 project for you to use as the starting point for
writing your Dynamic Link Library (DLL).

This file contains a summary of what you will find in each of the files that
make up your project.

ATLExample2012.vcxproj
    This is the main project file for VC++ projects generated using an Application Wizard.
    It contains information about the version of Visual C++ that generated the file, and
    information about the platforms, configurations, and project features selected with the
    Application Wizard.

ATLExample2012.vcxproj.filters
...
ATLExample2012.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (ATLExample2012.h)
        GUID definitions                                (ATLExample2012_i.c)
        A type library                                  (ATLExample2012.tlb)
        Marshaling code                                 (ATLExample2012_p.c and dlldata.c)

ATLExample2012.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in ATLExample2012.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named ATLExample2012.pch and a precompiled types file named StdAfx.obj.
...
ATLExample2012ps.vcxproj
	...
	dlldata.c, ATLExample2012_i.c and ATLExample2012_p.c which are required
	to build the proxy/stub DLL.

ATLExample2012ps.vcxproj.filters
