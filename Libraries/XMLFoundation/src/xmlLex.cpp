...
contentTop:;
		...
		{
			// When parsing XML with an invalid element <@CustomerID> or < ID>777 < / ID >
			// 
			// 1000 is well beyond any normal behavior of stream stacks within implementations i have seen
			// If you ever catch this exception with legitimate XML please post an error issue with  either the codeproject.com or github.com message forums 
			// attached to the source code release.
