...
//
// As of 2024 - SHA256 is still secure - and this file compiles with gcc on Linux, Clang on Android and VS2022.
//   SHA512 is more secure. XMLFoundation uses OpenSSL for SHA512.  OpenSSL also provides SHA256.
//
// In some situations, on some platforms, it could be necessary to define  __NO_OPENSSL and 
// use a basic set of algorithms within XMLFoundation therefore although this implementation
// is redundant, for now it remains as a fallback option.  
///////////////////////////////////////////////////////////////////////////////////////////////
...
#ifdef _UNICODE
		GString g2(pzFileName);
		HANDLE hFound = FindFirstFile(g2, &find);
#else
