...
__int64 GBTree::BulkInsertFromFile(const char* pzDelimiter, const char* pzFileName, void* pValue)
{
	GString g;
...
__int64 GBTree::BulkInsert(const char* pzDelimiter, const char* pzKeyList, void* pValue)
{
