...
int GStringList::ToFileAppend(const char *pzDelimiter, const char *pzPathAndFileName, int nStartIndex/* = 0*/, __int64 nItemCount/* = -1*/)
{
	Serialize(pzDelimiter, nStartIndex,nItemCount);
	return m_strSerializeDest.ToFileAppend(pzPathAndFileName,0);
}

void GStringList::SerializeTo(GString &strDest, const char *pzDelimiter, int nStartIndex/* = 0*/, __int64 nItemCount /*= -1*/)
{
	strDest = "";
	GStringIterator it(this);
	int nCount = 0;
...
const char *GStringList::Serialize(const char *pzDelimiter, int nStartIndex/* = 0*/, __int64 nItemCount /* = -1*/)
{
	m_strSerializeDest = "";
