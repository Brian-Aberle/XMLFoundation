...
#define CommonConstruct(nInitialSize)				\
	...
	_strIsOnHeap = 0;								\
	_max = nInitialSize;							\
	if (nInitialSize == GSTRING_INITIAL_SIZE_32)	\
		_str = _initialbuf;							\
	else											\
	{												\
		_initialbuf[0] = 0;							\
...
void GString32::Attach(const char *pzSource, __int64 nSrcLen, __int64 nMax, int nOwn)
{
	if (_strIsOnHeap == 1)
		delete[] _str;
...
void GString32::WriteOn(const char *src,__int64 n)
{
	if (src)
	{
		_len = 0;
...
__int64 GString32::SetFromUpToFirstOf(const char *pSrc, const char *pzUpToTerm)
{
...
__int64 GString32::AppendFromUpToFirstOf(const char *pSrc, const char *pzUpToTerm)
{
	char *p = (char *)strpbrk(pSrc,pzUpToTerm);
	if (p)
	{
...
__int64 GString32::AppendFromUpTo(const char *pSrc, const char *pzUpToTerm)
{
...
__int64 GString32::SetFromUpTo(const char *pSrc, const char *pzUpToTerm)
{
	char *p = (char *)strstr(pSrc,pzUpToTerm);
	if (p)
	{
...
void GString32::AppendEscapeXMLReserved(const char *Src, __int64 nLen/* = -1*/, int nSerializeFlags)
{
...
void GString32::EscapeXMLReserved()
{
...
void GString32::SetPreAlloc(__int64 l)
{
	if (l <= _max)
...
GString32::GString32(const char *src, __int64 nCnt, __int64 nMax, int nOwn)
{
	_initialbuf[0] = 0;
	_str = (char *)src;
	_len = nCnt;
...
GString32::GString32(__int64 nInitialSize,int nGrowByAllocationSize)
{
...
GString32::GString32(const GString &src )
{
	__int64 l = (src._len > GSTRING_INITIAL_SIZE_32) ? src._len + GSTRING_INITIAL_SIZE_32 : GSTRING_INITIAL_SIZE_32;
	CommonConstruct( l );
...
GString32::GString32(const GString &src, __int64 nCnt)
{
	__int64 l = (src._len > GSTRING_INITIAL_SIZE_32) ? src._len + GSTRING_INITIAL_SIZE_32 : GSTRING_INITIAL_SIZE_32;
	CommonConstruct(l);
...
GString32::GString32(const char *src)
{
	__int64 srcLen = (src) ? strlen(src) : GSTRING_INITIAL_SIZE_32;
	__int64 nInitialSize = (srcLen > GSTRING_INITIAL_SIZE_32) ? srcLen + GSTRING_INITIAL_SIZE_32 : GSTRING_INITIAL_SIZE_32;
...
GString32::GString32(const wchar_t *src)
{
	__int64 srcLen = (src) ? wcslen(src) : GSTRING_INITIAL_SIZE_32;
	__int64 nInitialSize = (srcLen > GSTRING_INITIAL_SIZE_32) ? srcLen + GSTRING_INITIAL_SIZE_32 : GSTRING_INITIAL_SIZE_32;
...
GString32::GString32(const char *src, __int64 nCnt)
{
	__int64 nInitialSize = (nCnt > GSTRING_INITIAL_SIZE_32) ? nCnt + GSTRING_INITIAL_SIZE_32 : GSTRING_INITIAL_SIZE_32;
...
GString32::GString32(char ch, short nCnt)
{
	short nInitialSize = (nCnt > GSTRING_INITIAL_SIZE_32) ? nCnt + GSTRING_INITIAL_SIZE_32 : GSTRING_INITIAL_SIZE_32;
	CommonConstruct(nInitialSize);
...
void GString32::Reset()
{
	if (_strIsOnHeap == 1)
		delete [] _str;
	CommonConstruct( GSTRING_INITIAL_SIZE_32 );
    if (_pWideStr)
	{
	    free(_pWideStr);
		_pWideStr = 0;
...
GString32 & GString32::operator=(char _p)
{
	if (!_max)
	{
		_max = 2;
...
GString32 & GString32::operator=(unsigned __int64 _p)
{
	char  szBuffer[33];
...
GString32 & GString32::operator=(__int64 _p)
{
	char  szBuffer[33];
...
GString32 & GString32::operator=(const char * _p)
{
	_len = 0;
	while (_p && *_p)
	{
...
GString32 & GString32::operator=(const signed char * _p)
{
	*this = (const char *)_p;
...
GString32 & GString32::operator=(unsigned char _p)
{
	*this = (char)_p;
...
GString32 & GString32::operator=(signed char _p)
{
	*this = (char)_p;
...
GString32 & GString32::operator=(short _p)
{
	char  szBuffer[25];
...
GString32 & GString32::operator=(unsigned short _p)
{
	char  szBuffer[25];
...
GString32 & GString32::operator=(int _p)
{
	char  szBuffer[25];
...
GString32 & GString32::operator=(unsigned int _p)
{
	char  szBuffer[25];
...
GString32 & GString32::operator=(long _p)
{
	char  szBuffer[25];
...
GString32 & GString32::operator=(unsigned long _p)
{
	char  szBuffer[25];
...
GString32 & GString32::operator=(float _p)
{
	char  szBuffer[50];
...
GString32 & GString32::operator=(double _p)
{
	char  szBuffer[50];
...
GString32 & GString32::operator=(long double _p)
{
	char  szBuffer[50];
...
GString32 & GString32::operator=(const GString & _p)
{
...
GString32 & GString32::operator=(const GString32 & _p)
{
...
void GString32::write(const char *p,__int64 nSize)
{
...
GString operator+(GString32 &_p1, GString32 &_p2)
{
...
GString operator+(GString32 &_p1, const char *_p2)
{
	GString strRet;
...
GString operator+(const char *_p1, GString32 &_p2)
{
	GString strRet;
...
GString operator+(GString32 &_p1, const signed char *_p2)
{
	GString strRet;
...
GString operator+(const signed char *_p1, GString32 &_p2)
{
	GString strRet;
...
GString operator+(GString32 &_p1, char _p2)
{
...
GString operator+(char _p1, GString32 &_p2)
{
...
GString operator+(GString32 &_p1, unsigned char _p2)
{
	GString strRet(_p1._len + 2);
...
GString operator+(unsigned char _p1, GString32 &_p2)
{
	GString strRet(_p2._len + 2);
...
GString operator+(GString32 &_p1, signed char _p2)
{
	GString strRet(_p1._len + 2);
...
GString operator+(signed char _p1, GString32 &_p2)
{
	GString strRet(_p2._len + 2);
...
int GString32::operator >  (const GString &s) const
{
...
int GString32::operator >  (const GString32 &s) const
{
	return strcmp(_str, s._str) > 0;
}
...
int GString32::operator >  (const GString0 &s) const
{
	return strcmp(_str, s._str) > 0;
}
...
int GString32::operator >  (const char *s) const
{
...
int GString32::Compare(const char *s) const
{
	return strcmp(_str, s);
}
int GString32::Compare(const char *s, int n) const
{
	return memcmp(_str, s, n);
}

int GString32::Compare(GString &s) const
{
	return strcmp(_str, s._str);
}

int GString32::CompareNoCase(const char *s, __int64 n) const
{
...
int GString32::CompareNoCase(const char *s) const
{
	__int64 i = 0;  // start at the beginning
...
int GString32::CompareNoCase(const GString &s) const
{
	__int64 i = 0;  // start at the beginning
...
int GString32::CompareSub(const char *s, __int64 i, __int64 z) const
{
	char ch = 0;
	if (z != -1 && z <= _len)
	{
...
int GString32::CompareSubNoCase(const char *s, __int64 i, __int64 z) const
{
	__int64 j = 0;
	// loop through the two strings comparing case insensitively
...
int GString32::CompareToFile(const char *pzFileAndPath, int nMatchCase)
{
	GString strTemp;
...
char& GString32::operator[](__int64 nIdx)
{
...
char& GString32::operator[](int nIdx)
{
	// check for subscript out of range
	if (nIdx > _len)
		throw GException("String", 1);
...
char GString32::GetAt(__int64 nIdx) const
{
	// check for subscript out of range
	if (nIdx > _len)
		throw GException("String", 1);
...
void GString32::SetAt(__int64 nIdx, char ch)
{
	// check for subscript out of range
...
void GString32::PadLeft(__int64 nCnt, char ch /* = ' ' */)
{
	if (nCnt > _len)
		Prepend(nCnt - _len, ch);
}

void GString32::Prepend(__int64 nCnt, char ch /* = ' ' */)
{
...
void GString32::TrimLeftBytes(__int64 i)
{
	if (i != 0)
	{
		_len -= i;
...
void GString32::TrimLeft(char ch /* = ' ' */, short nCnt /* = -1 */)
{
	int i = 0;
...
void GString32::PadRight(__int64 nCnt, char ch /* = ' ' */)
{
	if (nCnt > _len)
		Append(nCnt - _len, ch);
}

void GString32::Append(__int64 nCnt, char ch /* = ' ' */)
{
...
void GString32::TrimRightBytes(__int64 nCnt)
{
	if (_len >= nCnt)
		_len -= nCnt;
	_str[_len] = 0;
...
void GString32::TrimRight(char ch /* = ' ' */, short nCnt /* = -1 */)
{
...
GString GString32::Left (__int64 nCnt) const
{
	if (nCnt > _len)
		nCnt = _len;
...
GString GString32::Mid  (__int64 nFirst) const
{
	if (nFirst > _len)
		nFirst = _len;
...
GString GString32::Mid  (__int64 nFirst, __int64 nCnt) const
{
	if (nFirst > _len)
		nFirst = _len;
...
GString GString32::Right(__int64 nCnt) const
{
	if (nCnt > _len)
		nCnt = _len + 1;
...
void GString32::MakeUpper(__int64 nBeginIndex/*=0*/)
{
	for (__int64 i = nBeginIndex; i < _len; i++)
		_str[i] = toupper(_str[i]);
}

void GString32::MakeLower(__int64 nBeginIndex/*=0*/)
{
	for (__int64 i = nBeginIndex; i < _len; i++)
		_str[i] = tolower(_str[i]);
}

void GString32::MakeReverse()
{
...
__int64 GString32::FindCaseInsensitive( const char * lpszSub, __int64 nStart/* = 0*/ ) const
{
...
GString GString32::FindStringBetween(const char *pSearchForBegin, const char *pSearchForEnd) const
{
...
const char *GString32::FindStringAfter(const char *pSearchFor) const
{
...
__int64 GString32::FindOneOf(const char *pzCharsToSearchFor) const
{
...
void GString32::ReplaceChars(const char *pzCharSet, char chReplaceWith)
{
...
__int64 GString32::FindBinary(GString &strToFind, __int64 nStart/* = 0*/)
{
	__int64 nIndex = -1;
...
__int64 GString32::Find( char ch, __int64 nStart ) const
{
	if (nStart >= _len)
		return -1;
...
__int64 GString32::FindNth( char ch, int Nth, __int64 nStart/* = 0 */) const
{
	__int64 nRet = -1;
	for(int i=0; i<Nth; i++)
	{
...
__int64 GString32::ReverseFindOneOf( const char *pstr, __int64 nStart  ) const
{
...
__int64 GString32::ReverseFindOneOf( const char *pstr ) const
{
	return ReverseFindOneOf( pstr, _len );
}

__int64 GString32::ReverseFind( char ch ) const
{
	return ReverseFind( ch, _len );
}

__int64 GString32::ReverseFind( char ch, __int64 nStart ) const
{
	if (nStart > _len || nStart < 0)
		return -1;
...
int GString32::RemoveLast ( char ch )
{
...
int GString32::RemoveLast ( const char *pStr, int bMatchCase /*= 0*/)
{
...
__int64 GString32::ReverseFind( const char *pch, __int64 nStart/* = -1*/, int bMatchCase/* = 0*/ ) const
{
	if (nStart == -1)
		nStart = _len;
...
__int64 GString32::ReverseFindNth( const char *pstr, int Nth ) const
{
	__int64 nRet = -1;
...
__int64 GString32::Find( const char * lpszSub, __int64 nStart ) const
{
	if (nStart > _len)
		return -1;
...
__int64 GString32::FindNth( const char *pstr, int Nth, __int64 nStart/* = 0*/ ) const
{
	__int64 nRet = -1;
...
void GString32::OverWrite(const char *pzNew, __int64 nIndex/*=0*/, __int64 nLength/* = -1*/)
{
	if (nLength == -1)
...
__int64 GString32::InsertBefore( const char *pzMatch, const char *pzInsertThis, int bMatchCase /*= 0*/)
{
	__int64 nIndex;
	if (bMatchCase)
	{
...
__int64 GString32::InsertAfter( const char *pzMatch, const char *pzInsertThis, int bMatchCase /*= 0*/)
{
	__int64 nIndex;
	if (bMatchCase)
	{
...
void GString32::Insert( __int64 nIndex, char ch )
{
...
void GString32::Insert( __int64 nIndex, const char *pstr, __int64 nStrLen/* -1 */ )
{
	if (!pstr)
		return;
...
void GString32::MergeMask(const char *szSrc, const char *szMask)
{
	Empty();
...
void GString32::FormatNumber(const char *szFormat, 
...
void GString32::FormatBinary(const GString &strBinary, int bIncludeAscii/*=1*/)
{
	FormatBinary((unsigned char *)(const char *)strBinary, strBinary.Length(), bIncludeAscii);
}

void GString32::FormatBinary(unsigned char *pData, __int64 nBytes, int bIncludeAscii/*=1*/)
{
	if (!pData || nBytes < 1)
		return;
...
void GString32::FormatV(const char *lpszFormat, va_list argList)
{
try
{
#ifdef ___LINUX64	
...
void GString32::LoadResource(const char* szSystem, int error, ...)
{
...
void GString32::FormatAppend(const char *lpszFormat, ...)
{
	GString str;
	va_list argList;
...
void GString32::FormatPrepend(const char *lpszFormat, ...)
{
	GString str;
	va_list argList;
	va_start(argList, lpszFormat);
...
void GString32::Format(const char *lpszFormat, ...)
{
	va_list argList;
	va_start(argList, lpszFormat);
...
bool GString32::ToFileAppend(const char* pzFileName, bool bThrowOnFail /*= 1*/)
{
	int nTry = 0;
RETRY:
...
bool GString32::ToFile(const char* pzFileName, bool bThrowOnFail/* = 1*/)
{
	// c runtime fopen() throws exception when filename == "", so manage it here
	if (!pzFileName || pzFileName[0] == 0)
	{
...
bool GString32::FromFileAppend(const char* pzFileName, bool bThrowOnFail)
{
...
bool GString32::FromFile(const char* pzFileName, bool bThrowOnFail/* = 1*/)
{
	FILE *fp = 0;
...
void GString32::ReplaceCaseInsensitive( const char * szWhat, const char *szRep, __int64 nStart/* = 0*/, int nFirstOnly/* = 0*/  )
{
	if ((!szWhat) || (!szRep))
		return;
...
void GString32::Replace( const char * szWhat, const char *szRep, int nFirstOnly/* = 0*/ )
{
	if ((!szWhat) || (!szRep))
		return;
...
void GString32::Replace( char chWhat, char chRep, int nFirstOnly/* = 0*/ )
{
...
void GString32::Replace( const char * szWhat, char chRep, int nFirstOnly/* = 0*/ )
{
	char szRep[2];
	szRep[0] = chRep;
	szRep[1] = 0;
...
void GString32::Replace( char chWhat, const char *szRep, int nFirstOnly/* = 0*/ )
{
	if (chWhat)
	{
		char szWhat[2];
...
void GString32::Remove( __int64 nStart, __int64 nLen )
{
	// subscript out of range
	if (nStart + nLen > _len)
		throw GException("String", 1);
...
__int64 GString32::RemoveAll( char ch )
{
...
__int64 GString32::RemoveAll( const char *pStr, int bMatchCase /*= 0*/ )
{
	__int64 nRemoved = 0;
...
int GString32::RemoveFirst ( char ch )
{
	__int64 nLenCopy = _len;
	int nRemoved = 0;
	for(__int64 i=0; i<nLenCopy; i++)
...
int GString32::RemoveFirst ( const char *pStr, int bMatchCase /*= 0*/ )
{
	int nRemoved = 0;
...
void GString32::Translate(const char *szConvert, const char *szTo)
{
	if ((szConvert) && (szTo))
	{
...
//			s == "A%0AC"
//
const char *GString32::EscapeWithHex(const char *pzEscapeChars)
{
...
// reverse of GString32::EscapeWithHex()
void GString32::UnEscapeHexed()
{
...
void GString32 ::Inc(__int64 nAmount/* = 1*/)
{
...
void GString32 ::Dec(__int64 nAmount/* = 1*/)
{
	__int64 n = Xatoi64(StrVal());
	n -= nAmount;
	*this = n;
}
void GString32 ::Inc(const char *pzAmount)
{
	__int64 n = Xatoi64(StrVal());
...
void GString32 ::Dec(const char *pzAmount)
{
	__int64 n = Xatoi64(StrVal());
	__int64 n2 = Xatoi64(pzAmount);
	n -= n2;
...
const char *GString32::AbbreviateNumeric()
{
...
const char *GString32::CommaNumeric()
{
...
unsigned short GString32::GetPackedShort(__int64 index)
{
...
unsigned long GString32::GetPackedLong(__int64 index)
{
	// note:
...
unsigned __int64 GString32::GetPacked64(__int64 index)
{
...
bool GString32::Cipher( GString &strKey, GString *pSrc )
{
...
bool GString32::Cipher( GString &strKey ) 
{
	GString strTemp(*this);
	return Cipher( strKey, &strTemp); 
}
bool GString32::Cipher( const char *pzKey )
{
	GString strTemp(*this);
...
bool GString32::DeCipher( GString &strKey, GString *pSrc )
{
	GString strErrorOut;
	SetPreAlloc( pSrc->Length() + 64 );
	// convert to GString without making a copy
...
bool GString32::DeCipher( GString &strKey ) 
{ 
	GString strSrc(*this);
	return DeCipher(strKey,&strSrc);
}
bool GString32::DeCipher( const char *pzKey )
{
	GString strSrc(*this);
	GString strKey(pzKey);
	return DeCipher( strKey, &strSrc ); 
...
bool GString32::DeCompress( const char *pFileName, __int64 nDecompressedSize)
{
	GString strG;
...
bool GString32::DeCompress(__int64 nDecompressedSize) 
{
	GString strSrc(*this);
	Empty();
...
bool GString32::DeCompress( GString *pSrc, __int64 nDestSize)
{
	Empty();
...
bool GString32::Compress( GString *pSrc )
{
...
GString32::operator wchar_t * () const
{

    if (_pWideStr)
	{
	    free(_pWideStr);
		__pragma(warning(suppress:4213))
	...
	// cast on lvalue is necessary because its being accessed through a const object

//	__pragma(warning(suppress:3490))
...
GString32 & GString32::operator+=(const wchar_t * unicodestr)
{
