...
{
	GStack m_KeySpace;
	__int64 m_nCurrentKeySpaceIndex;
	__int64 m_nCurrentKeySpaceSize;
	__int64 m_nInitialKeySpaceSize;
	unsigned long m_nKeySpaceGrowBy;
...
public:
	// 	
	void SetKeySpace(__int64 nInitialSize, unsigned long nGrowBy) { m_nInitialKeySpaceSize = nInitialSize; m_nKeySpaceGrowBy = nGrowBy; }
...
public:
	...
	GQSortArray(unsigned long nGrowBy = 128) : GArray(nGrowBy) {}
	virtual ~GQSortArray(){};
};
