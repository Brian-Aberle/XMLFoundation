...
#include "Windows.h" //  only needed for HANDLE declaration - used below
...
struct gthread_mutex_t_ {
  HANDLE mutex;  
  // note: Android Studio fails here for targets x86 and x86_64 
  // however the ARMv7 and ARMv8 targets will build
  CRITICAL_SECTION cs;
};
