...
#ifdef ___LINUX64
#include	<x86intrin.h>					/* get prototype for _lrotl() , _lrotr() */
#pragma inline _lrotl
#pragma inline _lrotr
#undef	ROL1								/* get rid of inefficient definitions */
#undef	ROR
#define	ROL1(x,n)	_lrotl(x,n)		/* use compiler intrinsic rotations */
...
typedef uint32_t DWORD;
#else
	// most compilers treat unsigned long as 32 bit
typedef unsigned long DWORD;
#endif
