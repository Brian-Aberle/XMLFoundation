...
//
// This typedef is necessary if windows.h doesn't define it (e.g. WinCE and Visual Studio 6)
// however, this typedef must be removed in Visual Studio 2012 when building 64 bit
//
#ifndef _WIN64
