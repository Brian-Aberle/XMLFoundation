...
// look at CDoubleArrayAbstraction in AbstractionsMFC.h to see StringCollectionAbstraction used as a 
// base class abstraction  to store double's in an MFC CArray.
...
public:
	...
	virtual void removeAll(userStringList pList) = 0;											// added 2024
	virtual void remove(userStringList pList, const char* pString, bool bMatchCase) = 0;		// added 2024
};
