...
// XMLFoundation modification: MAX_ROUNDS was renamed to MAX_RROUNDS due to name collision with TwoFish
...
// Begin XMLFoundation code change ///////////////////////////////////////////////////////////////////////////////////////////////
// XMLFoundation note: This source code uses a C++14 std::exception 'ctor which is not standardly supported across various builds, compilers, and platforms
// in those places it throws empty Error descriptions

#if defined (___LINUX64) || defined(___ANDROID)
#define NOCXX14EXCEPTIONS
#endif


// End XMLFoundation code change ///////////////////////////////////////////////////////////////////////////////////////////////
...
private:
	...
	enum { MAX_BLOCK_SIZE=32, MAX_RROUNDS=14, MAX_KC=8, MAX_BC=8 };
...
private:
	...
	int m_Ke[MAX_RROUNDS+1][MAX_BC];
	//Decryption (m_Kd) round key
    int m_Kd[MAX_RROUNDS+1][MAX_BC];
	//Key Length
	int m_keylength;
	//Block Size
	int	m_blockSize;
