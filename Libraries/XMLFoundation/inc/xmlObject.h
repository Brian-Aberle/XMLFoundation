...
public:
	...
	// Map an integer
	void MapAttribute(__int64* pValue,	const char* pTag, const char* pzTranslationMapIn = 0, const char* pzTranslationMapOut = 0, int nTranslationFlags = 0);
...
//	void MapMember(GString32 *pValue,const char *pTag, const char *pzTranslationMapIn = 0, const char *pzTranslationMapOut = 0,int nTranslationFlags = 0);
	...
	// All other forms of ToXML ultimately call this one, and it is the only virtual ToXML().dump
	...
	// these methods do not throw GException, the do log to TRACE if you SetLogFile("c:\\XMLFoundation\\MyAppDebugLog.txt");   
	...
	__int64 GetObjectDescriptorCount();
	...
	__int64 IncRef(StackFrameCheck *pStack =0, int nDeep=1);
...
#define IMPLEMENT_FACTORY_NO_REG(class_name, xml_tag, base_class)		\
...
{																		\
	base_class::SetObjectTypeName(#class_name);							\
	base_class::SetDefaultXMLTag(#xml_tag);								\
	base_class::m_pDerivedAddress = this;								\
	base_class::m_classFactory = class_name::FactoryCreate;				\
}																		\
...
IMPLEMENT_FACTORY_NO_REG(class_name, xml_tag, class_name)				\
...
// ***********		IMPLEMENT_FACTORY	**************
#define IMPLEMENT_FACTORY_MI(class_name, xml_tag, base_class)			\
IMPLEMENT_FACTORY_NO_REG(class_name, xml_tag, base_class)				\
RegisterBusinessObject class_name##Unique(								\
					class_name::FactoryCreate,							\
					#xml_tag,											\
					#class_name);										\
