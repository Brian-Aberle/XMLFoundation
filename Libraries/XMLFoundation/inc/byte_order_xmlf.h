...
// when targeting ARM for Android and building with MSVC we need bswap to be defined
// and when targeting the same building with Android Studio we already have the bswap definition
#ifdef ___ANDROID
#ifndef ___KOTLIN_COMPILER
#ifndef bswap_64
