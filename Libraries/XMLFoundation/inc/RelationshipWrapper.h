...
class XMLRelationshipWrapper : public XMLObject
{
	...
	// 0=unknown, 1=list, 2=string list, 3=int array, 4=object, 5=objPointer, 6=KeyedDataStructure
...
public:
	...
	{	
		m_pData = m_pAccessor = 0;
		m_nContainedType = ContainedType_Unknown;
