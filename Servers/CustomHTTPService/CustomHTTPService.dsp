# Microsoft Developer Studio Project File - Name="CustomHTTPService" - Package Owner=<4>
# Microsoft Developer Studio Generated Build File, Format Version 6.00
# ** DO NOT EDIT **

# TARGTYPE "Win32 (x86) Console Application" 0x0103

CFG=CustomHTTPService - Win32 Debug
!MESSAGE This is not a valid makefile. To build this project using NMAKE,
!MESSAGE use the Export Makefile command and run
!MESSAGE 
!MESSAGE NMAKE /f "CustomHTTPService.mak".
!MESSAGE 
!MESSAGE You can specify a configuration when running NMAKE
!MESSAGE by defining the macro CFG on the command line. For example:
!MESSAGE 
!MESSAGE NMAKE /f "CustomHTTPService.mak" CFG="CustomHTTPService - Win32 Debug"
!MESSAGE 
!MESSAGE Possible choices for configuration are:
!MESSAGE 
!MESSAGE "CustomHTTPService - Win32 Release" (based on "Win32 (x86) Console Application")
!MESSAGE "CustomHTTPService - Win32 Debug" (based on "Win32 (x86) Console Application")
!MESSAGE 
...
# PROP BASE Output_Dir "CustomHTTPService__Win32_Debug"
# PROP BASE Intermediate_Dir "CustomHTTPService__Win32_Debug"
...
# Name "CustomHTTPService - Win32 Release"
# Name "CustomHTTPService - Win32 Debug"
